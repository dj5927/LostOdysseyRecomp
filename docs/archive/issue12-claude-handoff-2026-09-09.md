...
> **历史归档。** 本交接记录于 2026-09-09，保留当时的调查边界、复现材料和下一步探针计划。它不是当前 Issue 状态或执行指令；当前结论以 [Issue #12 调查记录](../notes/issue12-funeral-crash.md)、[根因记录](../notes/issue12-root-cause.md)和 [STATUS](../STATUS.md) 为准。
