...
| [Status ledger](STATUS.md) | Current source, validation scope, publication state and open boundaries |
...
| [Archive](archive/README.md) | Superseded status, release and roadmap snapshots |
