...
- [x] **坎托族魔装兵光照闪烁：**用户已验收第五版在报告场景中“不闪了”。只读核对进程为 PID 26188、`LostOdysseyRecomp-taa-material-candidate.exe`、runtime `1789278806155312`、源码 `0.5.6-hotfix1`，环境为 `Test-TAA-Lighting-5.cmd`、HDR 默认 0、materials 默认 1。产物 SHA-256 为 `F983446111909E353BB34A871CCD15E9B010F4C6B62311A3B4F2D062DA5180BE`。本条验收该报告遭遇中整面光影闪烁的修复，不代表所有场景保证。本地修复分支目标为 `trail/fix-taa-lighting`，尚未发布；若复发则重新打开本项。
