...
No current 0.5.4 reproduction, new production fix, player acceptance or release occurred. A clean-package cage-scene run and save are still needed.
...
Issue #16 remains OPEN. Vulkan and other-region coverage and player acceptance remain pending; Asia Disc 3 D3D12 final-branch target-scene validation and recovery are covered above. The implementation and local validation are committed as `2019cd017ab939d0b728cec340f7835c2082e615` and are included in the local `main` alongside its existing city-performance work. No push or release occurred. The validation executable and retained evidence remain source version 0.5.4.
...
The current PPC key is `50b8ad415be405b302252558e0fd960913c3ce6a15d991ae3607142f1a3821a5`. The imported PPC library remains byte-identical to the verified SHA-256 `ba3e4c4dff009d6d8e844c007186a6e5040266875bca6423f8fe26f8d27fb21b`; only its source-version fingerprint was re-exported, without PPC recompilation. The remote private cache lacked this key at the audit, and the exact upload has since completed at private commit `6a6ed03152431a232165e35b19b7f94f09bbbda9`; `lo.ppcAutoSync=false`. Hosted CI and release verification remain pending.
