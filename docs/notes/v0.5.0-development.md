...
> **历史开发记录。** 本页保留 v0.5.0 开发阶段的版本身份和验证边界。当前发布版本、实现状态与未完成范围以 [STATUS](../STATUS.md) 和[路线图](../ROADMAP.md)为准。

当前 tracker 核验时间为 2026-09-18T07:33:59Z：Issue #12 已 **CLOSED / Done**。下文出现的 OPEN 和待报告者确认措辞均属于当时的开发检查点；报告者验收、自然退出、全游戏覆盖和其他回归边界仍按原证据保留。
